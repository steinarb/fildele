...
import no.priv.bang.fildele.db.liquibase.test.FildeleTestDbLiquibaseRunner;
...
class FildeleServiceProviderTest {
    ...
    static void commonSetupForAllTests() throws Exception {
        ...
        var runner = new FildeleTestDbLiquibaseRunner();
        runner.activate();
    ...
    void testDefaultLocale() {
        ...
        assertEquals(NB_NO, fildele.defaultLocale());
    }
    ...
    void testAvailableLocales() {
        ...
        fildele.setUseradmin(useradmin);
        fildele.activate(Collections.singletonMap("defaultlocale", "nb_NO"));
        var locales = fildele.availableLocales();
        assertThat(locales).isNotEmpty().contains(LocaleBean.with().locale(fildele.defaultLocale()).build());
    }
    ...
    void testDisplayTextsForDefaultLocale() {
        ...
        fildele.setUseradmin(useradmin);
        fildele.activate(Collections.singletonMap("defaultlocale", "nb_NO"));
        var displayTexts = fildele.displayTexts(fildele.defaultLocale());
    ...
    void testDisplayText() {
        ...
        fildele.setUseradmin(useradmin);
        fildele.activate(Collections.singletonMap("defaultlocale", "nb_NO"));
        var text1 = fildele.displayText("hi", "nb_NO");
        assertEquals("Hei", text1);
        var text2 = fildele.displayText("hi", "en_GB");
        assertEquals("Hi", text2);
        var text3 = fildele.displayText("hi", "");
        assertEquals("Hei", text3);
        var text4 = fildele.displayText("hi", null);
