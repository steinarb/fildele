...
class FildelTestDbLiquibaseRunnerTest {
    ...
    void testFailWhenCreatingInitialSchema() throws Exception {
        ...
        var e = assertThrows(
            SQLException.class,
            () -> runner.prepare(datasource));
        assertThat(e.getMessage()).startsWith("Error creating fildele test database schema");
    }
    ...
    void testFailWhenAddingMockData() throws Exception {
        ...
        var e = assertThrows(
            SQLException.class,
            () -> runner.prepare(datasource));
        assertThat(e.getMessage()).startsWith("Error inserting fildele test database mock data");
    }
    ...
    void testFailWhenUpdatingSchema() throws Exception {
        ...
        var e = assertThrows(
            SQLException.class,
            () -> runner.prepare(datasource));
        assertThat(e.getMessage()).startsWith("Error updating fildele test database schema");
    }
