 ...
 * be put in front of the servlets in the "/fildele" webcontext, and
...
public class FildeleShiroFilter extends AuthserviceShiroFilterBase { // NOSONAR
    ...
    static {
        ...
        INI_FILE.load(FildeleShiroFilter.class.getClassLoader().getResourceAsStream("shiro.ini"));
    }
