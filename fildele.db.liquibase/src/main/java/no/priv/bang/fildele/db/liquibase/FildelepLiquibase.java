...
public class FildelepLiquibase extends LiquibaseClassPathChangeLogRunner {

    public void createInitialSchema(Connection connection) throws LiquibaseException {
        applyLiquibaseChangelist(connection, "fildele-db-changelog/db-changelog-1.0.0.xml");
    }

    public void updateSchema(Connection connection) throws LiquibaseException {
        applyLiquibaseChangelist(connection, "fildele-db-changelog/db-changelog-1.0.1.xml");
    }
